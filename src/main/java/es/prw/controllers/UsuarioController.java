...
public class UsuarioController {
    ...
    public ResponseEntity<Map<String, Object>> getPerfil(Authentication authentication) {
        ...
        String email = authentication.getName();
        return usuarioRepository.findByEmail(email)
                .map(usuario -> ResponseEntity.ok(Map.of("usuario", (Object) usuario))) // Asegura que el valor es de tipo Object
                .orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error", (Object) "Usuario no encontrado.")));
    }
    ...
    public ResponseEntity<Map<String, String>> cambiarPassword(
        ...
        if (cambioExitoso) {
            ...
            return ResponseEntity.ok(Map.of("message", "Contraseña actualizada correctamente. Inicie sesión de nuevo."));
        } else {
