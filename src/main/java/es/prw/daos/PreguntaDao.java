...
public List<Pregunta> getPreguntasConRespuestas(int idTest, HttpSession session) {
    ...
    try {
        while (rsPreguntas != null && rsPreguntas.next()) {
            ...
            // Obtener respuestas asociadas a la pregunta pasando la sesión
            RespuestaDao respuestaDao = new RespuestaDao();
            List<Respuesta> respuestas = respuestaDao.getRespuestasByPregunta(pregunta.getIdPregunta(), session);
